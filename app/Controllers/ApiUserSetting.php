...
class ApiUserSetting extends BaseController
{
        ...
        if ($validation->withRequest($this->request)->run() == FALSE){
            ...
            if($file = $this->request->getFile('file')) {
                if ($file->isValid() && ! $file->hasMoved()) {
                        ...
                        $filepath = base_url()."/public/uploads/".session()->get('user_id').'/'.$newName;
                        ...
                        $this->userModel->set(['signature'=>'/public/uploads/'.session()->get('user_id').'/'.$newName])
