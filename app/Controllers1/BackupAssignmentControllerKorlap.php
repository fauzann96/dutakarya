...
class BackupAssignmentControllerKorlap extends BaseController
{
    ...
    public function index(): string//terpakai
    {
        ...
        return view('backup_assignment/backup_index_korlap',$viewdata);
    }
    ...
    public function dataTable(){//terpakai
        ...
        $data->where('tb_backup_assignment.customer_seq',session()->get('customer'));
