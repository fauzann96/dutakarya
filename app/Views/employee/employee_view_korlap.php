            ...
            <div class="card <?php if($employee['resign_date'] != null){echo 'card-danger';} else{echo 'card-primary';}?> card-outline">
              <div class="card-body box-profile">
                <div class="text-center">
                  <img src="<?=base_url().$employee['foto_pas_path'].$employee['foto_pas']?>" alt="pas foto" class="img-thumbnail" style="opacity: 1;width:80%"><br>
                </div>
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="card <?php if($employee['resign_date'] != null){echo 'card-danger';} else{echo 'card-primary';}?>">
                  ...
                  <div class="card-body">
                    <div class="text-center">
                      <img src="<?=base_url().$employee['foto_sim_path'].$employee['foto_sim']?>" alt="pas foto" class="img-thumbnail" style="opacity: 1;width:80%"><br>
                    </div>
                    ...
                    <hr>
                    <strong><i class="fas fa-inbox mr-1"></i> Emergency</strong>
                    <p id="txt_email" class="text-muted">
              ...
              <div class="col-12 col-sm-6">
                <div class="card <?php if($employee['resign_date'] != null){echo 'card-danger';} else{echo 'card-primary';}?>">
                  ...
                  <div class="card-body">
                    <div class="text-center">
                      <img src="<?=base_url().$employee['foto_ktp_path'].$employee['foto_ktp']?>" alt="pas foto" class="img-thumbnail" style="opacity: 1;width:80%"><br>
                    </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content text-sm">
            ...
            <form id='resign_form' action=''>
                <div class="modal-body">
                  <div class="form-group row">
                    <label for="resign_note" class="col-sm-3 col-form-label">Catatan</label>
                    <div class="col-sm-9">
                      <textarea class="form-control" id='resign_note' name='resign_note' required></textarea>
                    </div>
                  </div>
                    <input type="hidden" id="csrf" class="txt_csrfname" name="<?= csrf_token() ?>" value="<?= csrf_hash()?>" />
                </div>
