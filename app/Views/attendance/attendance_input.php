          ...
          <div class="col-12 col-sm-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Pilih Customer dan Tanggal Absensi</h3>
              </div>
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <select id="choose_customer" name="choose_customer" class="form-control select2" required>
                    </select>
                  </div>
                </div>
                <div class="form-group row">
...
<script>
  ...
  $('#choose_customer').change(function (){
    loadAttendanceCustomerEmployeeOption($('#choose_employee'),$('#choose_customer').val());
  })
  var employeeList;
  $('#form_choose').validate({
      ...
      submitHandler:function(event){
        ...
        var bg_main_employee = 'bg-success';
        var bg_backup_employee = 'bg-info';
        ...
        let url="<?=base_url('/attendance/input/form_data')?>";
        var request = $.ajax({
          method: "POST",
          contentType: false,
  ...
  $("#form_attendance").submit(function(e){
    ...
    let url="<?=base_url('/attendance/input/submit')?>";
        var request = $.ajax({
          method: "POST",
          timeout: 30000,
          url: url,
          data: {
            ...
            'attendance_customer' : $('#choose_customer').val(),
