...
<script>
  ...
  function submitForm(){
    ...
    var request = $.ajax({
          url: '<?=base_url('/korlap/attendance/data/fetch')?>',
          type: 'POST',
          contentType: false,
  ...
  function generateExcel() {
    if($('#choose_start').val() && $('#choose_end').val()){
      window.location = "<?=base_url()?>"+'korlap/attendance/data/generate/excel/'+$('#choose_start').val()+'/'+$('#choose_end').val();
    }else{
      toastr('Harap isi periode');
    }
  ...
  function generatePDF(argument) {
    if($('#choose_start').val() && $('#choose_end').val()){
      window.location = "<?=base_url()?>"+'korlap/attendance/data/generate/pdf/'+$('#choose_start').val()+'/'+$('#choose_end').val();
    }else{
      toastr('Harap isi periode');
    }
  }
