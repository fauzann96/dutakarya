...
<script type="text/javascript">
  ...
  function loadDataTable(){
    table = $("#data_table").DataTable({
      ...
      ajax:{
        url:"<?=base_url('/assignment/backup/datatable')?>",
        type:"post",
    ...
    columns: [
        { data: null,type:'text',title:'NIP',className:'dt-body-center dt-head-center align-middle',render:function (data, type, row, meta) {
          return row.nip+' <div class="btn-group"><button type="button" id="edit" title="Edit" class="btn btn-warning btn-xs"><i class="far fa-edit"></i></button><button type="button" id="delete" title="Hapus" class="btn btn-danger btn-xs"><i class="fas fa-trash"></i></button></div>';
          }
        },
      ...
      autoWidth: false,
      buttons: [{
                  text: '<i class="fas fa-plus"></i> Buat Backup Baru',
                  className: 'btn-success btn-sm',
                  action: function (e, dt, node, config) {
                    loadCustomerOption($('#new_customer'));
                    loadCustomerOption($('#new_customer_destination'));
